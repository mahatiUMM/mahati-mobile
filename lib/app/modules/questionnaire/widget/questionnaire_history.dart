...
class QuestionnaireHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomMaterialIndicator(
      onRefresh: () => controller.refreshQuestionnaire(),
      ...
      indicatorBuilder: (context, controller) {
        return Padding(
          ...
          child: CircularProgressIndicator(
            ...
            value: controller.state.isLoading ? null : null,
          ),
        );
      },
      child: Obx(() => controller.isLoadingHistoryQuestionnaire.isTrue
          ? Center(
              child: CircularProgressIndicator(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Obx(() {
                          if (controller
                              .isLoadingAvailableQuestionnaire.value) {
                            return Center(
                              child: CircularProgressIndicator(
                                valueColor: AlwaysStoppedAnimation<Color>(
                            ...
                            return ListView.builder(
                              ...
                              itemCount:
                                  controller.questionnaireUserAlreadyUse.length,
                              itemBuilder: (context, index) {
                                final item = controller
                                    .questionnaireUserAlreadyUse[index];
                                return Padding(
